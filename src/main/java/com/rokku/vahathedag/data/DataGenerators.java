...
import com.rokku.vahathedag.data.client.ModBlockStateProvider;
import com.rokku.vahathedag.data.client.ModItemModelProvider;
...
@Mod.EventBusSubscriber(modid = VahaTheDagMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
